...
RUN yum install -y cmake gcc gcc-c++ zlib-devel python3-devel libuuid-devel openssl-devel sudo python3-pip

RUN pip3 install --upgrade argcomplete rucio-clients
RUN pip3 install wheel
RUN pip3 install xrootd
